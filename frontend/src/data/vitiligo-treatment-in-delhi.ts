...
export const VITILIGO_IMAGES = {
  hero: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Vitiligo treatment before and after results" },
  heroLegs: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Legs vitiligo before and after transformation" },
  heroFace: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Face vitiligo surgery results" },
  heroLip: { src: "/demo/skin-aesthetic-card.png", alt: "Lip vitiligo transplant results" },
  heroChest: { src: "/demo/ai-skin-scan-v2.png", alt: "Chest vitiligo recovery results" },
  heroCheek: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Cheek vitiligo transformation" },
  awareness: { src: "/demo/ai-skin-scan-v2.png", alt: "Vitiligo awareness infographic" },
  melanin: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Melanin loss and vitiligo development diagram" },
  technologies: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Vitiligo treatment technologies" },
  phototherapy: { src: "/demo/skin-aesthetic-card.png", alt: "NB-UVB phototherapy session" },
  melanocyte: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Melanocyte transplant procedure" },
  cosmetic: { src: "/demo/ai-skin-scan-v2.png", alt: "Vitiligo camouflage solutions" },
  drBhasin: { src: "/demo/doctor-profile-feature-vertical.png", alt: "Dr. Sandeep Bhasin — vitiligo specialist" },
  protocol: { src: "/demo/about-us-consultation.png", alt: "Step-by-step vitiligo treatment journey" },
  woodsLamp: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Wood's lamp examination" },
  medicalPhase: { src: "/demo/about-us-consultation.png", alt: "Medical treatment phase" },
  surgery: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Melanocyte transplant procedure" },
  repigmentation: { src: "/demo/skin-aesthetic-card.png", alt: "Phototherapy session" },
  maintenance: { src: "/demo/ai-skin-scan-v2.png", alt: "Long-term skin care plan" },
  candidate: { src: "/demo/about-us-consultation.png", alt: "Candidate assessment checklist" },
  myths: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Vitiligo myth vs fact infographic" },
  bodyAreas: { src: "/demo/ai-skin-scan-v2.png", alt: "Body areas affected by vitiligo" },
  melaninCauses: { src: "/demo/skin-aesthetic-card.png", alt: "Melanin production diagram" },
  earlySigns: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Early vitiligo symptoms" },
  types: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Vitiligo types classification chart" },
  management: { src: "/demo/skin-aesthetic-card.png", alt: "Vitiligo management overview" },
  protocolFlow: { src: "/demo/about-us-consultation.png", alt: "Advanced treatment protocol flowchart" },
  tattooing: { src: "/demo/ai-skin-scan-v2.png", alt: "Micropigmentation illustration" },
  future: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Future vitiligo research" },
  selfCare: { src: "/demo/ai-skin-scan-v2.png", alt: "Vitiligo self-care guide" },
  cost: { src: "/demo/skin-aesthetic-card.png", alt: "Vitiligo treatment cost breakdown" },
  clinic: {
    src: "/beardtranplantindelhi/care-well-medical-centre-delhi-clinic-exterior-1.webp",
    alt: "Care Well clinic and treatment team",
  },
  ctaBanner: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Book vitiligo consultation" },
  gallery: [
    { src: "/demo/ai-skin-scan-v3.jpg", alt: "Face vitiligo before and after", caption: "Face result" },
    { src: "/demo/skin-aesthetic-card.png", alt: "Lip vitiligo transplant", caption: "Lip transplant" },
    { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Hand vitiligo recovery", caption: "Hand recovery" },
    { src: "/demo/ai-skin-scan-v2.png", alt: "Chest vitiligo transformation", caption: "Chest transformation" },
    { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Leg vitiligo treatment", caption: "Leg treatment" },
    { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Melanocyte transplant success", caption: "Melanocyte transplant" },
  ],
} as const;
