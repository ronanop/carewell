...
export const ACNE_SCAR_IMAGES = {
  hero: {
    src: "/uploads/2026/d8050da0719725a6.jpg",
  ...
  causes: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Acne causes and scar formation infographic" },
  scarTypes: { src: "/demo/ai-skin-scan-v2.png", alt: "Different acne scar types" },
  pih: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "PIH vs acne scar comparison" },
  symptoms: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Acne scar symptoms illustration" },
  drBhasin: { src: "/demo/doctor-profile-feature-vertical.png", alt: "Dr. Sandeep Bhasin — cosmetic and laser surgeon" },
  drRiyaz: { src: "/demo/doctor-profile-feature.png", alt: "Dr. Riyaz — dermatologist and skin specialist" },
  technologies: { src: "/demo/skin-aesthetic-card.png", alt: "Advanced acne scar treatment technologies" },
  comparison: { src: "/demo/ai-skin-scan-v2.png", alt: "Acne scar treatment comparison chart" },
  eligibility: { src: "/demo/about-us-consultation.png", alt: "Treatment eligibility checklist" },
  prevention: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Acne prevention guide" },
  cost: { src: "/demo/skin-aesthetic-card.png", alt: "Acne scar treatment cost guide" },
  aftercare: { src: "/demo/carewell-clinic-exterior.png", alt: "Recovery and aftercare guide" },
  whyChoose: { src: "/beardtranplantindelhi/care-well-medical-centre-delhi-clinic-exterior-1.webp", alt: "Care Well clinic and treatment team" },
  ctaBanner: { src: "/demo/skin-aesthetic-card.png", alt: "Book acne scar consultation" },
  videoPoster: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Acne scar treatment patient testimonial" },
  gallery: [
    { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Acne scar before and after", caption: "Acne scar treatment result" },
    { src: "/demo/ai-skin-scan-v2.png", alt: "Rolling scar improvement", caption: "Rolling scar improvement" },
    { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Boxcar scar reduction", caption: "Boxcar scar reduction" },
    { src: "/demo/skin-aesthetic-card.png", alt: "Pigmentation correction", caption: "Pigmentation correction" },
    { src: "/demo/ai-skin-scan-v3.jpg", alt: "Laser resurfacing transformation", caption: "Laser resurfacing" },
    { src: "/demo/carewell-clinic-exterior.png", alt: "Full face texture improvement", caption: "Texture improvement" },
  ],
} as const;
