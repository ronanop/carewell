...
export const DARK_CIRCLES_IMAGES = {
  hero: {
    src: "/uploads/2026/10d9d4d7a6884495.png",
  ...
  tired: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Under-eye pigmentation before and after" },
  whatAre: { src: "/demo/ai-skin-scan-v2.png", alt: "Periorbital pigmentation illustration" },
  types: { src: "/demo/skin-aesthetic-card.png", alt: "Types of dark circles diagram" },
  signs: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Under-eye symptoms infographic" },
  causesMain: { src: "/demo/ai-skin-scan-v2.png", alt: "Causes of dark circles infographic" },
  genetic: { src: "/demo/about-us-consultation.png", alt: "Aging under-eye changes" },
  lifestyle: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Lifestyle triggers illustration" },
  medical: { src: "/demo/about-us-consultation.png", alt: "Health conditions linked to dark circles" },
  technologies: { src: "/demo/skin-aesthetic-card.png", alt: "Advanced under-eye rejuvenation treatments" },
  candidate: { src: "/demo/about-us-consultation.png", alt: "Ideal candidate assessment" },
  journey: { src: "/demo/ai-skin-scan-v2.png", alt: "Dark circle treatment journey" },
  aftercare: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Under-eye aftercare guide" },
  cost: { src: "/demo/skin-aesthetic-card.png", alt: "Dark circles treatment cost breakdown" },
  drBhasin: { src: "/demo/doctor-profile-feature-vertical.png", alt: "Dr. Sandeep Bhasin with patient" },
  ctaBanner: { src: "/demo/skin-aesthetic-card.png", alt: "Book dark circles consultation" },
  gallery: [
    { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Dark circles before and after", caption: "Before & after result" },
    { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Under-eye filler transformation", caption: "Filler transformation" },
    { src: "/demo/ai-skin-scan-v3.jpg", alt: "PRP treatment result", caption: "PRP result" },
    { src: "/demo/ai-skin-scan-v2.png", alt: "Laser pigmentation correction", caption: "Laser correction" },
    { src: "/demo/skin-aesthetic-card.png", alt: "Tear trough improvement", caption: "Tear trough improvement" },
    { src: "/demo/carewell-clinic-exterior.png", alt: "Under-eye brightening", caption: "Under-eye brightening" },
  ],
} as const;
