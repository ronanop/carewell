...
export const SKIN_WHITENING_IMAGES = {
  ...
  causes: { src: "/demo/ai-skin-scan-v2.png", alt: "Causes of skin pigmentation infographic" },
  whyChoose: { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Skin brightening transformation" },
  technologies: { src: "/demo/skin-aesthetic-card.png", alt: "Advanced skin whitening technologies" },
  assessment: { src: "/demo/about-us-consultation.png", alt: "Skin assessment consultation" },
  comparison: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Skin whitening treatment comparison chart" },
  permanent: { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Long-term skin whitening results" },
  cost: { src: "/demo/skin-aesthetic-card.png", alt: "Skin whitening cost breakdown" },
  benefits: { src: "/demo/ai-skin-scan-v2.png", alt: "Benefits of skin whitening infographic" },
  safety: { src: "/demo/ai-skin-scan-v3.jpg", alt: "Treatment safety illustration" },
  eligibility: { src: "/demo/about-us-consultation.png", alt: "Treatment eligibility checklist" },
  procedures: { src: "/demo/skin-aesthetic-card.png", alt: "Skin whitening procedure overview" },
  clinic: {
    src: "/beardtranplantindelhi/care-well-medical-centre-delhi-clinic-exterior-1.webp",
    alt: "Modern clinic and skin specialists",
  },
  drBhasin: { src: "/demo/doctor-profile-feature-vertical.png", alt: "Dr. Sandeep Bhasin professional portrait" },
  ctaBanner: { src: "/demo/skin-aesthetic-card.png", alt: "Book skin whitening consultation" },
  gallery: [
    { src: "/demo/skin-aesthetic-card.png", alt: "Skin whitening before and after", caption: "Before & after result" },
    { src: "/uploads/2026/d8050da0719725a6.jpg", alt: "Facial brightening", caption: "Facial brightening" },
    { src: "/demo/ai-skin-scan-v3.jpg", alt: "Pigmentation reduction", caption: "Pigmentation reduction" },
    { src: "/uploads/2026/10d9d4d7a6884495.png", alt: "Full body whitening progress", caption: "Full body progress" },
    { src: "/demo/ai-skin-scan-v2.png", alt: "Glutathione therapy outcome", caption: "Glutathione therapy" },
    { src: "/demo/carewell-clinic-exterior.png", alt: "Laser skin brightening", caption: "Laser brightening" },
  ],
} as const;
