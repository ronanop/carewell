...
export function CookieBanner() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[90] border-t border-surface bg-white/95 p-4 text-sm text-navy shadow-[0_-4px_20px_rgba(10,46,82,0.08)] backdrop-blur-sm md:bottom-4 md:left-4 md:right-auto md:max-w-md md:rounded-xl md:border"
      role="dialog"
