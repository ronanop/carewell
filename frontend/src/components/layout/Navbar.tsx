        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-3">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              rel="noreferrer"
              aria-label="WhatsApp"
              className="relative inline-flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#DFE3F0] bg-white transition-transform hover:scale-105"
